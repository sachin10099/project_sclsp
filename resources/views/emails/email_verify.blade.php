...
<tbody>
<tr style="color:#73706d;font-family:Helvetica Neue,Helvetica,Arial,sans-serif">
<td style="color:#73706d;font-family:Helvetica Neue,Helvetica,Arial,sans-serif">
...
<h1 style="color:#195090;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;font-weight:300;line-height:1.1;margin:0 0 20px">Hi {{$data['name']}},</h1>
<br>
<p style="color:#19121291;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;margin:0;font-size:16px;line-height:160%;font-weight:400;padding:0 0 32px;padding-bottom:0px">You're almost ready to enjoying our plateform.Simply click on the button below to verify your email address.</p><br>
<center><a href="{{ $data['link'] }}"><button style="background-color: green;color: white;">Verify email address</button></a></center>
&nbsp;
<p>{{$data['site']}} team wishes you a lot of fun on our platform!</p>
&nbsp;
...
<center>	
<p style="color:#b1aca0;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;margin:0;font-size:13px;line-height:18px;text-decoration:none;padding-bottom:24px">This email was sent to <a href="mailto:{{$data['company_email']}}" style="color:#8f8776;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;text-decoration:none;font-size:13px;line-height:18px" target="_blank"> {{$data['company_email']}} </a>.<br />
    If you have any questions or concerns, please email us at <a href="mailto:{{$data['company_email']}}" style="color:#8f8776;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;text-decoration:none;font-size:13px;line-height:18px" target="_blank"> {{$data['company_email']}} </a>.</p>
</center>
</td>
</tr>
</tbody>
