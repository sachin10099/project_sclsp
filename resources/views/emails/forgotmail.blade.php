...
<br>
<p style="color:#19121291;font-family:Helvetica Neue,Helvetica,Arial,sans-serif;margin:0;font-size:16px;line-height:160%;font-weight:400;padding:0 0 32px;padding-bottom:0px">Reset your password by clicking on the <a href="{{ $data['link'] }}">link</a>.</p>
&nbsp;
