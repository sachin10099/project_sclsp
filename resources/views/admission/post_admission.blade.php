...
<div class="content-wrapper">
    ...
    <section class="content edit-profile-section">
        <div class="form-listing-box bg-white global-shadow">
            <form method="post" action="{{ url('admin/admission/create') }}" enctype="multipart/form-data">
                @csrf
                <div class="row">
                	...
                	<br>
          			<strong style="color: red;">Note:</strong>  Please Select Admission End Date After Then Job Publish Date.
          			<br>
                  	<div class="row" style="margin-bottom: 10px;">
                  		<div class="col-sm-6">
	                        <label>Admission Published Date</label>
                  	...
                  	<div class="row" style="margin-bottom: 10px;">
                  		<div class="col-sm-6">
	                        <label>Total Sheets (Optional)</label>
                ...
                <div class="form-button">
                    <a href="{{ url('admin/admission/list-view') }}"><b-button type="submit" class="btn btn-warning">Cancel</b-button></a>
