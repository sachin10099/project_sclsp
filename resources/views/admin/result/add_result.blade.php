        ...
        <div class="content-wrapper">
            ...
            <section class="content edit-profile-section">
                <div class="form-listing-box bg-white global-shadow">
                    <form method="post" action="{{ url('form-filler/admit-card/list/edit') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
            ...
            <section class="content edit-profile-section">
                <div class="form-listing-box bg-white global-shadow">
                    <form method="post" action="{{ url('form-filler/results/add') }}" enctype="multipart/form-data">
                        @csrf
                        <div class="row">
                            <div class="col-sm-12">
                                <br>
                        ...
                        <div class="form-button">
                            <a href="{{ url('form-filler/results/list') }}"><b-button type="submit" class="btn btn-warning">Cancel</b-button></a>
                            <input type="submit" class="btn btn-info" value="Save">
                        </div>
                    </form>
                </div>
